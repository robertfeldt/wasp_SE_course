...
% \subsection*{Validation and verification (and maybe requirements engineering)}
...
% My experience is that you write a lot of code during a project, eventually you get something to work as you want it to, and that is when you try to write it together into a nice

% \section*{Select at least 2 principles/ideas/concepts/techniques from Robert's lectures and discuss how they relate to your research and topic area.}

% \section*{Select at least 2 principles/ideas/concepts/techniques from one of the three guest lectures and discuss how they relate to your research and topic area.}
...
%Black-box models with high predictive power can of course be very helpful, especially for specific applications, such as drug development. However, in general, they do not explain the underlying 

% active learning w human in the loop + ref
...
% chat gpt \& llms - how can this help, as we mostly understand natural language

% maybe also something about making eg genesis easy to use
...
% When finding an interesting paper I find it very helpful to run and look at code in parallel to reading it. Yet you are surprised how often this is either not available or provided in a way making it difficult to get to run, especially if it is a few years old.
...
% Being introduced to this field now during my PhD studies, I am surprised by how much manual labour experiments require
...
% will play an ever greater role in fields that have traditionally not been so software heavy, for instance experimental biology. 

% skriv lite om framtid för se - att chatgpt visat redan att mycket kan automatiseras

% se kommer såklart bli allt viktigare i alla områden inkusive biologi/pharma då jag verkligen tror att allt mer kommer automatiseras

% skriv lite om att jag tror att jag tror det mycket kommer handla om att typ prompt engineera för att få rätt program skrivet, samt validering för att säkerställa att rätt kod genereras

% också att i vissa fält kommer det nog dröja ganska länge innan detta kommer användas av säkerhetsskäl

% ai/ml in general - jag tror det är en stor möjlighet ich viktigt att se till att det inte bara leder till mer tillgångar som hamnar hos de som redan har mycket och färre jobb etc, istället bra möjlighet att t ex låta folk jobba mindre osv
